export const FooterSimple = props => (
  <footer class="bg-white">
    <div class="mx-auto max-w-7xl py-12 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
      ...
      <div class="mt-8 md:order-1 md:mt-0">
        <p class="text-center text-base text-gray-400">© 2020 Your Company, Inc. All rights reserved.</p>
      </div>
    </div>
  </footer>
)

export const FooterCentered = props => (
  <footer class="bg-white">
    <div class="mx-auto max-w-7xl overflow-hidden py-12 px-4 sm:px-6 lg:px-8">
      ...
      <p class="mt-8 text-center text-base text-gray-400">© 2020 Your Company, Inc. All rights reserved.</p>
    </div>
  </footer>
)
  ...
  <footer class="bg-white" aria-labelledby="footer-heading">
    ...
    <div class="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
      ...
      <div class="mt-12 border-t border-gray-200 pt-8">
        <p class="text-base text-gray-400 xl:text-center">© 2020 Your Company, Inc. All rights reserved.</p>
      </div>
    </div>
  </footer>
)